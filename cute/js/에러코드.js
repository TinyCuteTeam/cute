let count = 16; // 새로운 행의 ID를 위한 카운트 변수
        ...
        function adderroreditButton(cell) {
            ...
            erroreditButton.innerHTML = '<img src=https://cdn-icons-png.flaticon.com/512/764/764599.png style="width: 10px;">';
        ...
        function adderrordelButton(cell) {
            ...
            errordelButton.innerHTML = '<img src="https://cdn-icons-png.flaticon.com/512/484/484662.png" style="width: 10px;">';
